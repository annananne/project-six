    ...
    return (
      <div className="main-wrapper clearfix">
        <div className="newtripform-wrapper">
          ...
          >
            <form
              className="new-trip-form clearfix"
              action=""
            ...
            >
              ...
              <LocationSearchInput
                id="originData"
                address={this.props.originData.address}
              ...
              <LocationSearchInput
                id="destinationData"
                address={this.props.destinationData.address}
                destinationData={this.props.destinationData}
                handleChange={this.props.handleChange}
                handleSelect={this.props.handleSelect}
              />
              <DateTimeInput
                dateString={this.props.originDateTime}
                ...
                <fieldset>
                  <li>
                    ...
                    <input
                      ...
                      checked={
                        this.props.userTripPreferences.travelMode === "DRIVING" // className="no-display"
                      }
                    />
                  </li>
        ...
        <div className="image-wrapper">
          <img
            src={mockImage}
            alt="A person in the passenger seat of a car looking at a map."
          />
        </div>
      </div>
    );
